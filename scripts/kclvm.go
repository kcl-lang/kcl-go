...
const (
	...
	KclvmVersionType_latest                  = KclvmVersionType_v0_4_4_alpha_2

	KclvmVersionType_v0_4_4_alpha_2 KclvmVersionType = "v0.4.4-alpha.2"
...
var (
	...
	KclvmMd5sum = map[string]string{
		// https://github.com/KusionStack/KCLVM/releases/tag/v0.4.4-alpha.2
		"kclvm-v0.4.4-alpha.2-Darwin.tar.gz":       "", // read from *.md5.txt
		"kclvm-v0.4.4-alpha.2-Darwin-arm64.tar.gz": "", // read from *.md5.txt
		"kclvm-v0.4.4-alpha.2-centos.tar.gz":       "", // read from *.md5.txt
		"kclvm-v0.4.4-alpha.2-ubuntu.tar.gz":       "", // read from *.md5.txt
