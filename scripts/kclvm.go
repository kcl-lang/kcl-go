...
const (
	KclvmAbiVersion         KclvmVersionType = KclvmVersionType_v0_4_5
...
var (
	...
	KclvmMd5sum = map[string]string{
		...
		"kclvm-v0.4.5-alpha.2-centos.tar.gz":       "", // read from *.md5.txt
		"kclvm-v0.4.5-alpha.2-ubuntu.tar.gz":       "", // read from *.md5.txt
		"kclvm-v0.4.5-alpha.2-windows.zip":         "", // read from *.md5.txt

		// https://github.com/KusionStack/KCLVM/releases/tag/v0.4.5-alpha.1
		"kclvm-v0.4.5-alpha.1-Darwin.tar.gz":       "", // read from *.md5.txt
		"kclvm-v0.4.5-alpha.1-Darwin-arm64.tar.gz": "", // read from *.md5.txt
		"kclvm-v0.4.5-alpha.1-centos.tar.gz":       "", // read from *.md5.txt
		"kclvm-v0.4.5-alpha.1-ubuntu.tar.gz":       "", // read from *.md5.txt
		"kclvm-v0.4.5-alpha.1-windows.zip":         "", // read from *.md5.txt

		// https://github.com/KusionStack/KCLVM/releases/tag/v0.4.4
		"kclvm-v0.4.4-Darwin.tar.gz":       "", // read from *.md5.txt
		"kclvm-v0.4.4-Darwin-arm64.tar.gz": "", // read from *.md5.txt
		"kclvm-v0.4.4-centos.tar.gz":       "", // read from *.md5.txt
		"kclvm-v0.4.4-ubuntu.tar.gz":       "", // read from *.md5.txt
		"kclvm-v0.4.4-windows.zip":         "", // read from *.md5.txt

		// https://github.com/KusionStack/KCLVM/releases/tag/v0.4.4-beta.2
		"kclvm-v0.4.4-beta.2-Darwin.tar.gz":       "", // read from *.md5.txt
		"kclvm-v0.4.4-beta.2-Darwin-arm64.tar.gz": "", // read from *.md5.txt
		"kclvm-v0.4.4-beta.2-centos.tar.gz":       "", // read from *.md5.txt
		"kclvm-v0.4.4-beta.2-ubuntu.tar.gz":       "", // read from *.md5.txt
		"kclvm-v0.4.4-beta.2-windows.zip":         "", // read from *.md5.txt
