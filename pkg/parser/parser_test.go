...
func TestParseFileInTheWholeRepo(t *testing.T) {
	...
	err := filepath.Walk(root, func(path string, info os.FileInfo, err error) error {
		...
		// The kcl-lang/lib checkout (used by the unreleased sourcemap
		// replace) sits inside the workspace and contains KCL test fixtures
		// generated by the Rust toolchain that kcl-go's parser does not
		// understand. Skip that subtree.
		if info.IsDir() && info.Name() == "kcl-lang-lib" {
